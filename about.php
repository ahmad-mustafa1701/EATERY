...
<section class="about">
   <div class="row">
      <div class="content">
         <h3>why choose us?</h3>
         <p>At Eatery Restaurant, we stand out as your preferred dining destination for several reasons. Our skilled chefs are dedicated to creating culinary wonders, ensuring each dish is a delightful masterpiece. With a diverse menu featuring fast food, main dishes, drinks, and desserts, we cater to a wide range of tastes. Quality is our priority, and we source only the freshest, premium ingredients for a flavor-rich experience. Beyond the delectable offerings, our warm ambiance, efficient service, and commitment to community connection make dining with us an unforgettable experience, setting Eatery apart as the go-to choice for discerning food enthusiasts!</p>
